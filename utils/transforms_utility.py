...
class CIFAR10Albumentation:
    """Contains All transformations methods and techniques applied on CIFAR10 dataset
    """
    ...
    def train_transform(self,mean,std):
        """Applies transformations of CIFAR10 Train Data

        Args:
            mean ([type]): Mean of CIIFAR10 Dataset
            std ([type]): Standard Deviation of CIFAR10 Dataset

        Returns:
            [type]: transofrmed dataset
        """
        mean = eval(mean)
        std = eval(std)
...
class CIFAR10AlbumentationS9:
    """Conatins All transformation methods and techniques applied on CIFAR10 dataset
       customized tarnsformations for solving session9 assignment
    """
